    ...
    <div className="welcome">
      ...
      <div className="welcome-text">
        ...
        <h3>
          ...
          utifrån era individuella önskemål. Oavsett om du söker blommor till en
          stor högtid eller lite vardagsglädje, så har vi alltid säsongens
          vackraste blomster i lager.
          ...
          Välkommen till Konvaljen – Där blommor är vår stora passion i livet!
        </h3>
      </div>
